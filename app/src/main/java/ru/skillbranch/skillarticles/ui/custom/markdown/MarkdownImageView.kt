...
class MarkdownImageView private constructor(
    ...
    override val spannableContent: Spannable get() = tvTitle.text as Spannable
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        ivImage.layout(left, usedHeight, right, usedHeight + ivImage.measuredHeight)

        usedHeight += ivImage.measuredHeight + titleTopMargin

        tvTitle.layout(left, usedHeight, right, usedHeight + tvTitle.measuredHeight)
        tvAlt?.layout(
            left,
...
class AspectRatioResizeTransform : BitmapTransformation() {
    ...
    override fun hashCode(): Int = Companion.ID.hashCode()

    companion object {
        //any unique string
        private const val ID = "ru.skillbranch.skillarticles.glide.AspectRatioResizeTransform"
    }
}